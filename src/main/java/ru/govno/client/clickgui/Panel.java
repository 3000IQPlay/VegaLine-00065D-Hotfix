...
public class Panel {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.anim.getAnim();
      this.anim.to = !this.wantToClose && this.open ? (this.open ? 1.0F : this.anim.anim) : 0.0F;
      ...
      GL11.glTranslated((double)(this.posX.anim + this.dragX), (double)(this.posY.anim + this.dragY), 0.0);
      ...
      GL11.glTranslated((double)(-(this.posX.getAnim() + this.dragX)), (double)(-(this.posY.anim + this.dragY)), 0.0);
   ...
   public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
      ...
      if (this.wantToClick && this.ishover(this.X, this.Y, this.X + this.getWidth(), this.Y + 25.0F, mouseX, mouseY)) {
         if (Mouse.isButtonDown(0) && Client.clickGuiScreen.panels.stream().allMatch(panel -> !panel.dragging)) {
            ...
            if (this.open) {
               ...
               this.anim.to = 0.0F;
               this.mods.forEach(modx -> modx.binding = false);
            } else {
               this.open = true;
               ClientTune.get.playGuiPenelOpenOrCloseSong(this.open);
            }
      ...
      if (this.open) {
         ...
         for (Mod mod : this.mods) {
            mod.mouseClicked((int)this.X, (int)this.Y + i, mouseX, mouseY, mouseButton);
