...
public class ClickTeleport extends Module {
   ...
   public ClickTeleport() {
      ...
      get = this;
      this.settings.add(this.Mode = new ModeSettings("Mode", "Matrix", this, new String[]{"Matrix", "Vanilla", "Spartan"}));
   }
   ...
   public void onClick(EventInput e) {
      if (e.getKey() == 1) {
         ...
         if (base != null) {
            ...
            this.teleport((double)((float)this.posBlock.getX() + 0.5F), (double)MathUtils.clamp(y, 5, 256), (double)((float)this.posBlock.getZ() + 0.5F));
         }
      }
   }
